...
function Home() {
    return(
        <section id="home" className="min-h-screen place-content-center flex justify-center p-5 pt-5 bg-no-repeat bg-cover object-contain bg-fixed" style={{ backgroundImage: "url(" + "https://i.postimg.cc/JnJHwfds/bg1-dark.png" +")"}}>
   <div className="container text-white content-center p-10">
<h1 className="heading text-7xl text-bold flex justify-center object-center">Hi, I'm Fatima Galant</h1>
