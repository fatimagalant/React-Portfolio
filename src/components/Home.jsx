export default function Home() {
    return(
        <section id="home" className="min-h-screen place-content-center flex justify-center p-5 pt-20 bg-no-repeat bg-cover object-contain" style={{ backgroundImage: "url(" + "https://i.postimg.cc/JnJHwfds/bg1-dark.png" +")"}}>
   <div className="container text-white content-center">
