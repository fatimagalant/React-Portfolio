export default function About() {
    return(
        <section id="about" className="bg-no-repeat bg-cover object-contain bg-[#0e0e11]">
 ...
 Seeking opportunities to contribute to challenging projects and build a diverse portfolio of impressive web applications.</h3>
            {/* <div className="social-icons text-white">
                <div className="row">
                    ...
                    <div><i class="fa-brands fa-linkedin text-3xl"></i></div>
                    <div><i class="fa-brands fa-github text-3xl"></i></div>
                    <div><i class="fa-brands fa-codepen text-3xl"></i></div>
                    </div>
                </div>
            </div> */}
                </div>
